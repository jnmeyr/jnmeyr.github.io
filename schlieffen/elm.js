...
Elm.Actions.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var TriggerKeyboard = function (a) {    return {ctor: "TriggerKeyboard",_0: a};};
   var TriggerMouse = {ctor: "TriggerMouse"};
   var MoveMouse = function (a) {    return {ctor: "MoveMouse",_0: a};};
   var ResizeWindow = function (a) {    return {ctor: "ResizeWindow",_0: a};};
   return _elm.Actions.values = {_op: _op,ResizeWindow: ResizeWindow,MoveMouse: MoveMouse,TriggerMouse: TriggerMouse,TriggerKeyboard: TriggerKeyboard};
};
Elm.Size = Elm.Size || {};
Elm.Size.make = function (_elm) {
   "use strict";
   _elm.Size = _elm.Size || {};
   if (_elm.Size.values) return _elm.Size.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var sizeEncoder = function (size) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "width",_1: $Json$Encode.$float(size.width)}
                                         ,{ctor: "_Tuple2",_0: "height",_1: $Json$Encode.$float(size.height)}]));
   };
   var size = function (_p0) {    var _p1 = _p0;return {width: $Basics.toFloat(_p1._0),height: $Basics.toFloat(_p1._1)};};
   var Size = F2(function (a,b) {    return {width: a,height: b};});
   var sizeDecoder = A3($Json$Decode.object2,
   Size,
   A2($Json$Decode._op[":="],"width",$Json$Decode.$float),
   A2($Json$Decode._op[":="],"height",$Json$Decode.$float));
   return _elm.Size.values = {_op: _op,size: size,sizeEncoder: sizeEncoder,sizeDecoder: sizeDecoder,Size: Size};
};
...
Elm.Position.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var distance = F2(function (from,to) {    return $Basics.sqrt(Math.pow(from.x - to.x,2) + Math.pow(from.y - to.y,2));});
   var positionEncoder = function (position) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "x",_1: $Json$Encode.$float(position.x)}
                                         ,{ctor: "_Tuple2",_0: "y",_1: $Json$Encode.$float(position.y)}]));
   };
   var position = function (_p0) {    var _p1 = _p0;return {x: $Basics.toFloat(_p1._0),y: $Basics.toFloat(_p1._1)};};
...
Elm.Country.make = function (_elm) {
   "use strict";
   _elm.Country = _elm.Country || {};
   if (_elm.Country.values) return _elm.Country.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var countryEncoder = function (country) {
      var _p0 = country;
      switch (_p0.ctor)
      {case "Austria": return $Json$Encode.string("Austria");
         case "England": return $Json$Encode.string("England");
         case "France": return $Json$Encode.string("France");
         case "Germany": return $Json$Encode.string("Germany");
         case "Italy": return $Json$Encode.string("Italy");
         case "Russia": return $Json$Encode.string("Russia");
         default: return $Json$Encode.string("Turkey");}
   };
   var countryColor = function (country) {
      var _p1 = country;
      switch (_p1.ctor)
      {case "Austria": return $Color.orange;
         case "England": return $Color.purple;
         case "France": return $Color.blue;
         case "Germany": return $Color.grey;
         case "Italy": return $Color.green;
         case "Russia": return $Color.red;
         default: return $Color.yellow;}
   };
   var Turkey = {ctor: "Turkey"};
   var Russia = {ctor: "Russia"};
   var Italy = {ctor: "Italy"};
   var Germany = {ctor: "Germany"};
   var France = {ctor: "France"};
   var England = {ctor: "England"};
   var Austria = {ctor: "Austria"};
   var charCountry = function ($char) {
      var _p2 = $char;
      switch (_p2.valueOf())
      {case "1": return $Maybe.Just(Austria);
         case "2": return $Maybe.Just(England);
         case "3": return $Maybe.Just(France);
         case "4": return $Maybe.Just(Germany);
         case "5": return $Maybe.Just(Italy);
         case "6": return $Maybe.Just(Russia);
         case "7": return $Maybe.Just(Turkey);
         default: return $Maybe.Nothing;}
   };
   var stringCountry = function (string) {
      var _p3 = string;
      switch (_p3)
      {case "Austria": return $Maybe.Just(Austria);
         case "England": return $Maybe.Just(England);
         case "France": return $Maybe.Just(France);
         case "Germany": return $Maybe.Just(Germany);
         case "Italy": return $Maybe.Just(Italy);
         case "Russia": return $Maybe.Just(Russia);
         case "Turkey": return $Maybe.Just(Turkey);
         default: return $Maybe.Nothing;}
   };
   var countryDecoder = A2($Json$Decode.map,function (_p4) {    return A2($Maybe.withDefault,Austria,stringCountry(_p4));},$Json$Decode.string);
   return _elm.Country.values = {_op: _op
                                ,charCountry: charCountry
...
Elm.Kind = Elm.Kind || {};
Elm.Kind.make = function (_elm) {
   "use strict";
   _elm.Kind = _elm.Kind || {};
   if (_elm.Kind.values) return _elm.Kind.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var kindEncoder = function (kind) {
      var _p0 = kind;
      switch (_p0.ctor)
      {case "Army": return $Json$Encode.string("Army");
         case "Fleet": return $Json$Encode.string("Fleet");
         default: return $Json$Encode.string("Supply");}
   };
   var kindShape = function (kind) {
      var _p1 = kind;
      switch (_p1.ctor)
      {case "Army": return $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: 0,_1: 0}
                                                             ...
                                                             ,{ctor: "_Tuple2",_0: 0,_1: 2}
                                                             ,{ctor: "_Tuple2",_0: 0,_1: 0}]));
         case "Fleet": return $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: 0,_1: 0}
                                                                ...
                                                                ,{ctor: "_Tuple2",_0: 16,_1: 0}
                                                                ,{ctor: "_Tuple2",_0: 0,_1: 0}]));
         default: return $Graphics$Collage.circle(8);}
   };
   var Supply = {ctor: "Supply"};
   var Fleet = {ctor: "Fleet"};
   var Army = {ctor: "Army"};
   var charKind = function ($char) {
      var _p2 = $char;
      switch (_p2.valueOf())
      {case "a": return $Maybe.Just(Army);
         case "f": return $Maybe.Just(Fleet);
         case "s": return $Maybe.Just(Supply);
         default: return $Maybe.Nothing;}
   };
   var stringKind = function (string) {
      var _p3 = string;
      switch (_p3)
      {case "Army": return $Maybe.Just(Army);
         case "Fleet": return $Maybe.Just(Fleet);
         case "Supply": return $Maybe.Just(Supply);
         default: return $Maybe.Nothing;}
   };
   var kindDecoder = A2($Json$Decode.map,function (_p4) {    return A2($Maybe.withDefault,Army,stringKind(_p4));},$Json$Decode.string);
   return _elm.Kind.values = {_op: _op
                             ,charKind: charKind
                             ,stringKind: stringKind
                             ,kindShape: kindShape
                             ,kindEncoder: kindEncoder
                             ,kindDecoder: kindDecoder
                             ,Army: Army
                             ,Fleet: Fleet
                             ,Supply: Supply};
};
Elm.Unit = Elm.Unit || {};
Elm.Unit.make = function (_elm) {
   "use strict";
   _elm.Unit = _elm.Unit || {};
   if (_elm.Unit.values) return _elm.Unit.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Country = Elm.Country.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $Kind = Elm.Kind.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Position = Elm.Position.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var unitEncoder = function (unit) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "id",_1: $Json$Encode.$int(unit.id)}
                                         ,{ctor: "_Tuple2",_0: "country",_1: $Country.countryEncoder(unit.country)}
                                         ,{ctor: "_Tuple2",_0: "kind",_1: $Kind.kindEncoder(unit.kind)}
                                         ,{ctor: "_Tuple2",_0: "position",_1: $Position.positionEncoder(unit.position)}]));
   };
   var unit = function (id) {    return {id: id,country: $Country.Austria,kind: $Kind.Army,position: $Position.position({ctor: "_Tuple2",_0: 0,_1: 0})};};
   var Unit = F4(function (a,b,c,d) {    return {id: a,country: b,kind: c,position: d};});
   var unitDecoder = A5($Json$Decode.object4,
   Unit,
   A2($Json$Decode._op[":="],"id",$Json$Decode.$int),
   A2($Json$Decode._op[":="],"country",$Country.countryDecoder),
   A2($Json$Decode._op[":="],"kind",$Kind.kindDecoder),
   A2($Json$Decode._op[":="],"position",$Position.positionDecoder));
   return _elm.Unit.values = {_op: _op,unit: unit,unitEncoder: unitEncoder,unitDecoder: unitDecoder,Unit: Unit};
};
Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Size = Elm.Size.make(_elm),
   $Unit = Elm.Unit.make(_elm);
   var _op = {};
   var $try = function (decoder) {    return $Json$Decode.oneOf(_U.list([$Json$Decode.$null($Maybe.Nothing),A2($Json$Decode.map,$Maybe.Just,decoder)]));};
   var mark = F2(function (encoder,a) {    var _p0 = a;if (_p0.ctor === "Just") {    return encoder(_p0._0);} else {    return $Json$Encode.$null;}});
   var star = function (encoder) {    return function (_p1) {    return $Json$Encode.list(A2($List.map,encoder,_p1));};};
   var modelEncoder = function (model) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "size",_1: $Size.sizeEncoder(model.size)}
                                         ,{ctor: "_Tuple2",_0: "position",_1: $Position.positionEncoder(model.position)}
                                         ,{ctor: "_Tuple2",_0: "units",_1: A2(star,$Unit.unitEncoder,model.units)}
                                         ,{ctor: "_Tuple2",_0: "unit",_1: A2(mark,$Unit.unitEncoder,model.unit)}
                                         ,{ctor: "_Tuple2",_0: "nextId",_1: $Json$Encode.$int(model.nextId)}]));
   };
   var model = {size: $Size.size({ctor: "_Tuple2",_0: 1218,_1: 1118})
               ,position: $Position.position({ctor: "_Tuple2",_0: 0,_1: 0})
               ,units: _U.list([])
               ,unit: $Maybe.Nothing
               ,nextId: 0};
   var Model = F5(function (a,b,c,d,e) {    return {size: a,position: b,units: c,unit: d,nextId: e};});
   var modelDecoder = A6($Json$Decode.object5,
   Model,
   A2($Json$Decode._op[":="],"size",$Size.sizeDecoder),
   A2($Json$Decode._op[":="],"position",$Position.positionDecoder),
   A2($Json$Decode._op[":="],"units",$Json$Decode.list($Unit.unitDecoder)),
   A2($Json$Decode._op[":="],"unit",$try($Unit.unitDecoder)),
   A2($Json$Decode._op[":="],"nextId",$Json$Decode.$int));
   return _elm.Model.values = {_op: _op,model: model,modelEncoder: modelEncoder,modelDecoder: modelDecoder,Model: Model};
};
...
Elm.Update.make = function (_elm) {
   ...
   $Unit = Elm.Unit.make(_elm);
   var _op = {};
   _op["#"] = F2(function (_p0,size) {    var _p1 = _p0;return {x: $Basics.toFloat(_p1._0) / size.width,y: 1.0 - $Basics.toFloat(_p1._1) / size.height};});
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "ResizeWindow": return {ctor: "_Tuple2",_0: _U.update(model,{size: $Size.size({ctor: "_Tuple2",_0: _p2._0._0,_1: _p2._0._1})}),_1: $Effects.none};
         case "MoveMouse": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{position: A2(_op["#"],{ctor: "_Tuple2",_0: _p2._0._0,_1: _p2._0._1},model.size)})
                                  ,_1: $Effects.none};
         case "TriggerMouse": return {ctor: "_Tuple2"
                                     ,_0: function () {
                                        var _p3 = model.unit;
                                        if (_p3.ctor === "Just") {
                                              return _U.update(model,
                                              {units: A2($Basics._op["++"],model.units,_U.list([_U.update(_p3._0,{position: model.position})]))
                                              ,unit: $Maybe.Nothing});
                                           } else {
                                              var _p5 = $List.head(A2($List.filter,
                                              function (_p4) {
                                                 return A2(F2(function (x,y) {    return _U.cmp(x,y) > 0;}),2.5e-2,$Basics.snd(_p4));
                                              },
                                              A2($List.map,
                                              function (unit) {
                                                 return {ctor: "_Tuple2",_0: unit,_1: A2($Position.distance,model.position,unit.position)};
                                              },
                                              model.units)));
                                              if (_p5.ctor === "Just") {
                                                    var _p7 = _p5._0._0;
                                                    return _U.update(model,
                                                    {units: A2($List.filter,
                                                    function (_p6) {
                                                       return A2(F2(function (x,y) {    return !_U.eq(x,y);}),_p7.id,function (_) {    return _.id;}(_p6));
                                                    },
                                                    model.units)
                                                    ,unit: $Maybe.Just(_p7)});
                                                 } else {
           ...
           return {ctor: "_Tuple2"
                  ,_0: function () {
                     ...
                     if (_p8.ctor === "Just") {
                           ...
                           var _p9 = _p14;
                           if (_p9.valueOf() === " ") {
                                 return _U.update(model,{unit: $Maybe.Nothing});
                              } else {
                                 var _p10 = $Country.charCountry(_p14);
                                 if (_p10.ctor === "Just") {
                                       return _U.update(model,{unit: $Maybe.Just(_U.update(_p12,{country: _p10._0}))});
                                    } else {
                                       var _p11 = $Kind.charKind(_p14);
                                       if (_p11.ctor === "Just") {
                                             return _U.update(model,{unit: $Maybe.Just(_U.update(_p12,{kind: _p11._0}))});
                                          } else {
                                             return model;
                                          }
                                    }
                           ...
                           var _p13 = _p14;
                           if (_p13.valueOf() === " ") {
                                 return _U.update(model,{unit: $Maybe.Just($Unit.unit(model.nextId)),nextId: model.nextId + 1});
                              } else {
                                 return model;
                              }
                        }
...
Elm.View.make = function (_elm) {
   ...
   $Unit = Elm.Unit.make(_elm);
   var _op = {};
   var unitForm = function (unit) {
      var shape = $Kind.kindShape(unit.kind);
      return $Graphics$Collage.group(_U.list([A2($Graphics$Collage.outlined,_U.update($Graphics$Collage.defaultLine,{width: 2}),shape)
                                             ,A2($Graphics$Collage.filled,$Country.countryColor(unit.country),shape)]));
   };
   var mapElement = function (model) {
      return A3($Graphics$Element.image,$Basics.round(model.size.width),$Basics.round(model.size.height),"resources/map.png");
   };
   _op["@"] = F2(function (position,size) {
      return {ctor: "_Tuple2",_0: position.x * size.width - size.width / 2.0,_1: position.y * size.height - size.height / 2.0};
   });
   var unitsElement = function (model) {
      return A3($Graphics$Collage.collage,
      $Basics.round(model.size.width),
      $Basics.round(model.size.height),
      A2($List.map,function (unit) {    return A2($Graphics$Collage.move,A2(_op["@"],unit.position,model.size),unitForm(unit));},model.units));
   };
   var unitElement = function (model) {
      return A3($Graphics$Collage.collage,
      $Basics.round(model.size.width),
      $Basics.round(model.size.height),
      function () {
         var _p0 = model.unit;
         if (_p0.ctor === "Just") {
               return _U.list([A2($Graphics$Collage.move,A2(_op["@"],model.position,model.size),unitForm(_p0._0))]);
            } else {
               return _U.list([]);
            }
      }());
   ...
   var view = F2(function (address,model) {
      return $Html.fromElement(A4($Graphics$Element.container,
      $Basics.round(model.size.width),
      $Basics.round(model.size.height),
      $Graphics$Element.middle,
      $Graphics$Element.layers(_U.list([mapElement(model),unitsElement(model),unitElement(model)]))));
   });
...
Elm.Inputs.make = function (_elm) {
   ...
   var _op = {};
   var inputs = _U.list([A2($Signal.map,$Actions.ResizeWindow,$Window.dimensions)
                        ,A2($Signal.map,$Actions.MoveMouse,$Mouse.position)
                        ,A2($Signal.map,$Basics.always($Actions.TriggerMouse),$Mouse.clicks)
                        ,A2($Signal.map,function (_p0) {    return $Actions.TriggerKeyboard($Char.fromCode(_p0));},$Keyboard.presses)]);
   return _elm.Inputs.values = {_op: _op,inputs: inputs};
};
Elm.App = Elm.App || {};
Elm.App.make = function (_elm) {
   ...
   var fromModel = function (model) {    return A2($Json$Encode.encode,0,$Model.modelEncoder(model));};
   var toModel = function (string) {
      var _p0 = string;
      if (_p0.ctor === "Just") {
            var _p1 = A2($Json$Decode.decodeString,$Model.modelDecoder,_p0._0);
            if (_p1.ctor === "Ok") {
   ...
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: A2($Maybe.withDefault,$Model.model,toModel(getStorage)),_1: $Effects.none}
                             ,update: $Update.update
                             ,view: $View.view
                             ,inputs: $Inputs.inputs});
   var main = app.html;
   var setStorage = Elm.Native.Port.make(_elm).outboundSignal("setStorage",function (v) {    return v;},A2($Signal.map,fromModel,app.model));
